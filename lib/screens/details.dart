...
class _CoffeeDetailsState extends State<CoffeeDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: SingleChildScrollView(padding: EdgeInsets.only(bottom: 10),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                          '1.5k',
                          style: GoogleFonts.bigShouldersText(
                              color: ConstColor.firstSlice, fontSize: 20.0),
                      ),
                      SizedBox(width: 15.0),
                      Container(
                        width: 1.0,
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('images/coffee3.png'),
                  fit: BoxFit.cover
                )
              )
            )
            ...
            child: Column(
              ...
              children: [
                Text(
                  price,
                  style: GoogleFonts.bigShouldersText(
                      color: ConstColor.firstSlice, fontSize: 25.0),
                ),
                Text(
                  'COLD BREW KIT',
                  style: GoogleFonts.bigShouldersText(
